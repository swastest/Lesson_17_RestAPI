...
public class HomeworkTest {
    ...
    void getListUsers2() {
        ...
        String body = "{ page: 2, per_page: 6, total: 12, total_pages: 2, data: [ { id: 7, email: \"michael.lawson@reqres.in\", 
            first_name: \"Michael\", last_name: \"Lawson\", avatar: \"https://reqres.in/img/faces/7-image.jpg\" }, 
    ...
    void getListResource() {
        String body = "{ page: 1, per_page: 6, total: 12, total_pages: 2, data: 
    ...
    void putUpdate() {
        ...
        given()
                ...
                .body("updatedAt", notNullValue()); // не поняла как решить. начение динамичное ? все ндинамические значения вот так notNullValue()   - просто что там не пусто
    }
